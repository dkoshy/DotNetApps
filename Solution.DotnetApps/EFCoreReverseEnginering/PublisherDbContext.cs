...
namespace EFCoreReverseEnginering;

/*
 * *
 * * scaffolded command example
  Scaffold-DbContext 'host=localhost;port=5432;Database=PublisherDB;Username=postgres;Password=postgres;Timeout=10;sslmode=prefer' Npgsql.EntityFrameworkCore.PostgreSQL
 */
public partial class PublisherDbContext : DbContext
{
